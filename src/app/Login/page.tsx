...
function Login() {
    ...
    return <>
        <div className="flex h-screen justify-center items-center" style={{ backgroundImage: 'url(/images/bgLogin.png)' }}>
            <div className='flex flex-col items-center bg-background-color w-4/12 justify-center rounded-xl py-6 space-y-8 shadow-lg shadow-zinc-800 border-3'>
                ...
                <form className="w-8/12 items-center flex-col flex" action="" method="POST">
                    <div className="mt-4 relative w-full flex space-x-2 items-center">
                        ...
                        <FloatiInput text={'Email'} />
                    </div>
                    <div className="mt-10 relative w-full flex space-x-2 items-center">
                        <Lock strokeWidth={2} width={30} height={30} />
                        <FloatiInput text={'Senha'} />
                    </div>

                    <input type="sumbit" value="Logar" className="mt-8 w-8/12 py-2 rounded-xl bg-success hover:bg-green-600 text-white font-semibold text-center block focus:outline-none focus:ring focus:ring-offset-2 focus:bg-green focus:ring-opacity-80 cursor-pointer" />
                </form>
            </div>
        </div>
    </>
